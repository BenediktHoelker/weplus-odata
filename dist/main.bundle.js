...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__ = __webpack_require__(919);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_deviation_model__ = __webpack_require__(458);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_yard_delivery_model__ = __webpack_require__(718);
...
var DeliveryService = (function () {
    ...
    DeliveryService.prototype.createHeaders = function (contentType) {
        return new __WEBPACK_IMPORTED_MODULE_0__angular_http__["c" /* Headers */]({ 'Content-Type': contentType });
    };
    ...
    DeliveryService.prototype.createRequestOptions = function (headers, search) {
        return new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* RequestOptions */]({ headers: headers, search: search });
    };
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/delivery.service.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "d", function() { return ADD_DELIVERIES; });
/* harmony export (binding) */ __webpack_require__.d(exports, "h", function() { return CREATE_DELIVERY; });
/* harmony export (binding) */ __webpack_require__.d(exports, "i", function() { return REMOVE_DELIVERY; });
/* harmony export (binding) */ __webpack_require__.d(exports, "j", function() { return SELECT_DELIVERY; });
/* harmony export (binding) */ __webpack_require__.d(exports, "k", function() { return UPDATE_DELIVERY; });
/* harmony export (binding) */ __webpack_require__.d(exports, "n", function() { return SHOW_PROCESSED; });
/* harmony export (binding) */ __webpack_require__.d(exports, "o", function() { return SHOW_NOT_PROCESSED; });
/* harmony export (binding) */ __webpack_require__.d(exports, "m", function() { return SHOW_ALL_P; });
/* harmony export (binding) */ __webpack_require__.d(exports, "q", function() { return SHOW_REGISTERED; });
/* harmony export (binding) */ __webpack_require__.d(exports, "r", function() { return SHOW_NOT_REGISTERED; });
/* harmony export (binding) */ __webpack_require__.d(exports, "p", function() { return SHOW_ALL_R; });
/* harmony export (binding) */ __webpack_require__.d(exports, "e", function() { return ADD_YARDS; });
/* harmony export (binding) */ __webpack_require__.d(exports, "t", function() { return CREATE_YARD; });
/* harmony export (binding) */ __webpack_require__.d(exports, "l", function() { return FILTER_YARD; });
/* harmony export (binding) */ __webpack_require__.d(exports, "s", function() { return SELECT_YARD; });
/* harmony export (binding) */ __webpack_require__.d(exports, "f", function() { return ADD_DEVIATION_TYPES; });
/* harmony export (binding) */ __webpack_require__.d(exports, "g", function() { return FILTER_DEVIATION_TYPE; });
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/actions.js.map
...
var AppComponent = (function () {
    function AppComponent(deliveryService, store) {
        ...
        this.deliveryService.getDeliveries()
            .map(function (payload) { return ({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["d" /* ADD_DELIVERIES */], payload: payload }); })
            .subscribe(function (action) { return _this.store.dispatch(action); });
        this.deliveryService.getYards()
            .map(function (payload) { return ({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["e" /* ADD_YARDS */], payload: payload }); })
            .subscribe(function (action) { return _this.store.dispatch(action); });
        this.deliveryService.getDeviationTypes()
            .map(function (payload) { return ({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["f" /* ADD_DEVIATION_TYPES */], payload: payload }); })
            .subscribe(function (action) { return _this.store.dispatch(action); });
        /*
        ...
        */
        this.subscription = this.store
            ...
            deviationTypes.map(function (deviationType) {
                _this.deviationFilterActions.push({ friendly: deviationType.name + " Deviation", type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["g" /* FILTER_DEVIATION_TYPE */], payload: deviationType.name });
            });
        });
        console.log(this.deviationFilterActions);
        this.model = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].combineLatest(store.select('deliveries'), store.select('deviationFilter'), store.select('deviationTypes'), store.select('processingFilter'), store.select('registrationFilter'), store.select('selectedDelivery'), store.select('selectedYard'), store.select('yardFilter'), store.select('yards'), function (deliveries, deviationFilter, deviationTypes, processingFilter, registrationFilter, selectedDelivery, selectedYard, yardFilter, yards) {
            return {
    ...
    AppComponent.prototype.createDelivery = function () {
        this.selectDelivery();
        this.store.dispatch({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["h" /* CREATE_DELIVERY */], payload: { yardDeliveries: this.yardDeliveries } });
    ...
    AppComponent.prototype.removeDelivery = function (delivery) {
        ...
        if (delivery._id) {
            this.deliveryService.removeDelivery(delivery)
                .subscribe(function (response) { _this.store.dispatch({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["i" /* REMOVE_DELIVERY */], payload: delivery }); });
        }
        else {
            this.store.dispatch({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["i" /* REMOVE_DELIVERY */], payload: delivery });
        }
    };
    ...
    AppComponent.prototype.selectDelivery = function (delivery) {
        ...
        this.store.dispatch({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["j" /* SELECT_DELIVERY */], payload: delivery });
    };
    AppComponent.prototype.updateDelivery = function (delivery) {
        var _this = this;
        this.deliveryService.submitDelivery(delivery)
            .subscribe(function (delivery) { return _this.store.dispatch({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["k" /* UPDATE_DELIVERY */], payload: delivery }); });
        this.selectDelivery();
    };
    ...
    AppComponent.prototype.updateYardFilter = function (yard) {
        this.selectDelivery();
        this.store.dispatch({ type: __WEBPACK_IMPORTED_MODULE_5__reducers_actions__["l" /* FILTER_YARD */], payload: yard });
    };
    __decorate([
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/app.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_delivery_model__ = __webpack_require__(717);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_delivery_service__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__registration_dialog_registration_dialog_component__ = __webpack_require__(459);
...
var DeliveryDetailComponent = (function () {
    function DeliveryDetailComponent(deliveryService, dialog, snackBar) {
        this.deliveryService = deliveryService;
        this.dialog = dialog;
    ...
    DeliveryDetailComponent.prototype.openDialog = function () {
        var _this = this;
        this.dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_4__registration_dialog_registration_dialog_component__["a" /* RegistrationDialogComponent */], {
            disableClose: false,
        });
    ...
    DeliveryDetailComponent.prototype.openSnackBar = function (delivery) {
        var _this = this;
        var timeslotBegin = Date.parse(delivery.timeslotBegin.toString());
        var timeslotEnd = Date.parse(delivery.timeslotEnd.toString());
        if (delivery.isRegistered && !this.isOnTime(timeslotBegin, timeslotEnd, Date.now())) {
            var snackBarRef = this.snackBar.open("Delivery not on time", "Comment", {
                duration: 2000
            });
    ...
    DeliveryDetailComponent.prototype.isOnTime = function (timeslotBegin, timeslotEnd, now) {
        return (now > timeslotBegin && now < timeslotEnd);
    };
    __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])(), 
        __metadata('design:type', (typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__models_delivery_model__["a" /* Delivery */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__models_delivery_model__["a" /* Delivery */]) === 'function' && _a) || Object)
    ...
    DeliveryDetailComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_1__angular_material__["MdSnackBar"]]
        }), 
        __metadata('design:paramtypes', [(typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__shared_delivery_service__["a" /* DeliveryService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__shared_delivery_service__["a" /* DeliveryService */]) === 'function' && _d) || Object, (typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__angular_material__["MdDialog"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_material__["MdDialog"]) === 'function' && _e) || Object, (typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_material__["MdSnackBar"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__angular_material__["MdSnackBar"]) === 'function' && _f) || Object])
    ], DeliveryDetailComponent);
    return DeliveryDetailComponent;
    var _a, _b, _c, _d, _e, _f;
}());
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/delivery-detail.component.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/deviation.model.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_material__ = __webpack_require__(255);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return RegistrationDialogComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/registration-dialog.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app___ = __webpack_require__(716);
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/main.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_flex_layout__ = __webpack_require__(618);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_material__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ngrx_store__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngrx_store_devtools__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ngrx_store_log_monitor__ = __webpack_require__(695);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_hammerjs__ = __webpack_require__(884);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__delivery_list_delivery_list_component__ = __webpack_require__(711);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__shared_delivery_service__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__deviation_deviation_component__ = __webpack_require__(712);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__delivery_detail_delivery_detail_component__ = __webpack_require__(457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__directives_deviation_focus_directive__ = __webpack_require__(713);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__directives_focus_input_directive__ = __webpack_require__(714);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__filter_bar_filter_bar_component__ = __webpack_require__(715);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__reducers_delivery_reducer__ = __webpack_require__(720);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__reducers_deviation_type_reducer__ = __webpack_require__(721);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__reducers_filter_deviation_reducer__ = __webpack_require__(722);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__reducers_filter_processing_reducer__ = __webpack_require__(723);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__reducers_filter_registration_reducer__ = __webpack_require__(724);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__reducers_filter_yard_reducer__ = __webpack_require__(725);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__reducers_selected_delivery_reducer__ = __webpack_require__(726);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__reducers_selected_yard_reducer__ = __webpack_require__(727);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__reducers_yard_reducer__ = __webpack_require__(728);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__registration_dialog_registration_dialog_component__ = __webpack_require__(459);
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_28__registration_dialog_registration_dialog_component__["a" /* RegistrationDialogComponent */],
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_28__registration_dialog_registration_dialog_component__["a" /* RegistrationDialogComponent */]
            ],
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/app.module.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/delivery-list.component.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/deviation.component.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/deviation-focus.directive.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/focus-input.directive.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_yard_model__ = __webpack_require__(719);
...
var FilterBarComponent = (function () {
    ...
    FilterBarComponent.prototype.ngOnInit = function () {
        this.processingFilters = [
            { friendly: "All", type: __WEBPACK_IMPORTED_MODULE_1__reducers_actions__["m" /* SHOW_ALL_P */] },
            { friendly: "Processed", type: __WEBPACK_IMPORTED_MODULE_1__reducers_actions__["n" /* SHOW_PROCESSED */] },
            { friendly: "Not Processed", type: __WEBPACK_IMPORTED_MODULE_1__reducers_actions__["o" /* SHOW_NOT_PROCESSED */] }
        ];
        this.registrationFilters = [
            { friendly: "All", type: __WEBPACK_IMPORTED_MODULE_1__reducers_actions__["p" /* SHOW_ALL_R */] },
            { friendly: "Registered", type: __WEBPACK_IMPORTED_MODULE_1__reducers_actions__["q" /* SHOW_REGISTERED */] },
            { friendly: "Not Registered", type: __WEBPACK_IMPORTED_MODULE_1__reducers_actions__["r" /* SHOW_NOT_REGISTERED */] }
        ];
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/filter-bar.component.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/index.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/delivery.model.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/yard-delivery.model.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/yard.model.js.map
...
var deliveriesReducer = function (state, action) {
    ...
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["d" /* ADD_DELIVERIES */]:
            return action.payload;
        case __WEBPACK_IMPORTED_MODULE_0__actions__["h" /* CREATE_DELIVERY */]:
            return [
                Object.assign({}, {
        ...
        case __WEBPACK_IMPORTED_MODULE_0__actions__["i" /* REMOVE_DELIVERY */]:
            return state.filter(function (delivery) { return delivery._id !== action.payload._id; });
        case __WEBPACK_IMPORTED_MODULE_0__actions__["k" /* UPDATE_DELIVERY */]:
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/delivery.reducer.js.map
...
var deviationTypeReducer = function (state, action) {
    if (state === void 0) { state = []; }
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["f" /* ADD_DEVIATION_TYPES */]:
            return action.payload;
        default:
            return state;
    }
};
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/deviation-type.reducer.js.map
...
var filterDeviationReducer = function (state, action) {
    ...
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["g" /* FILTER_DEVIATION_TYPE */]:
            console.log(action);
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/filter-deviation.reducer.js.map
...
var filterProcessingReducer = function (state, action) {
    if (state === void 0) { state = function (delivery) { return delivery; }; }
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["m" /* SHOW_ALL_P */]:
            return function (delivery) { return delivery; };
        case __WEBPACK_IMPORTED_MODULE_0__actions__["n" /* SHOW_PROCESSED */]:
            return function (delivery) { return delivery.isProcessed; };
        case __WEBPACK_IMPORTED_MODULE_0__actions__["o" /* SHOW_NOT_PROCESSED */]:
            return function (delivery) { return !delivery.isProcessed; };
        default:
            return state;
    }
};
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/filter-processing.reducer.js.map
...
var filterRegistrationReducer = function (state, action) {
    if (state === void 0) { state = function (delivery) { return delivery; }; }
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["p" /* SHOW_ALL_R */]:
            return function (delivery) { return delivery; };
        case __WEBPACK_IMPORTED_MODULE_0__actions__["q" /* SHOW_REGISTERED */]:
            return function (delivery) { return delivery.isRegistered; };
        case __WEBPACK_IMPORTED_MODULE_0__actions__["r" /* SHOW_NOT_REGISTERED */]:
            return function (delivery) { return !delivery.isRegistered; };
        default:
            return state;
    }
};
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/filter-registration.reducer.js.map
...
var filterYardReducer = function (state, action) {
    if (state === void 0) { state = function (delivery) { return delivery; }; }
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["l" /* FILTER_YARD */]:
            if (action.payload.name === 'All') {
                return function (delivery) { return delivery; };
            }
            return function (delivery) { return delivery.yardDeliveries.find(function (yardDelivery) {
                return ((yardDelivery.yard.name === action.payload.name) && (yardDelivery.quantity >> 0));
            }); };
        default:
            return state;
    }
};
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/filter-yard.reducer.js.map
...
var selectedDeliveryReducer = function (state, _a) {
    ...
    switch (type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["j" /* SELECT_DELIVERY */]:
            return payload;
        default:
            return state;
    }
};
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/selected-delivery.reducer.js.map
...
var selectedYardReducer = function (state, _a) {
    var type = _a.type, payload = _a.payload;
    switch (type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["s" /* SELECT_YARD */]:
            return payload;
        default:
            return state;
    }
};
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/selected-yard.reducer.js.map
...
var yardReducer = function (state, action) {
    if (state === void 0) { state = []; }
    switch (action.type) {
        case __WEBPACK_IMPORTED_MODULE_0__actions__["e" /* ADD_YARDS */]:
            return action.payload;
        case __WEBPACK_IMPORTED_MODULE_0__actions__["t" /* CREATE_YARD */]:
            return state.concat([
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/yard.reducer.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/environment.js.map
...
//# sourceMappingURL=/Users/benedikthoelker/Desktop/weplus/src/polyfills.js.map
